                ...
                _decideData = function(that,index,num){
                    ...
                    switch (index){
                        case 1:
                             ...
                             */
                            _bind(that,function(event){
                                cache(that).setBorder;
                                _decide(that,num);
                                that.appendChild(activeDiv.div);
                            });
                            _bindMove(that,function(event){
                                activeDiv.div.style.left = event.changedTouches[0].clientX + 'px';
                                activeDiv.div.style.top = event.changedTouches[0].clientY + 'px';
