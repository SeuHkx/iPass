                            ...
                            that._move(el,function(event){
                                ...
                                for(;i < l ; i +=1){
                                     ...
                                     if(num == index){
                                          ...
                                          * 打印数据
                                          */
                                         //that._drawLine(pointData.location[index].x,pointData.location[index].y,pointData.location[num].x,pointData.location[num].y);

                                         console.log(pointData._data);
                                         console.log(pointData.location[num].y);
                                         console.log(num);
